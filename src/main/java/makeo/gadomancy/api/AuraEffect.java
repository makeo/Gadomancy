...
public abstract class AuraEffect {
     ...
     *      range and fires {@link #doBlockEffect(net.minecraft.util.BlockPos, net.minecraft.util.BlockPos, net.minecraft.world.World)}
     *
     ...
     * @return if the entity should be handled with {@link #doEntityEffect(net.minecraft.util.BlockPos, net.minecraft.entity.Entity)}
     */
     ...
     */
    public abstract void doEntityEffect(BlockPos originTile, Entity e);
     ...
     */
    public abstract void doBlockEffect(BlockPos originTile, BlockPos selectedBlock, World world);
    ...
    public static abstract class EntityAuraEffect extends AuraEffect {
        ...
        @Override
        public final void doBlockEffect(BlockPos originTile, BlockPos selectedBlock, World world) {}
    }
    ...
    public static abstract class BlockAuraEffect extends AuraEffect {
        ...
        @Override
        public final void doEntityEffect(BlockPos originTile, Entity e) {}
