...
public class PotionAchromatic extends PotionCustomTexture {
    public PotionAchromatic() {
        super(false, Aspect.CRYSTAL.getColor(), Aspect.CRYSTAL.getImage());
    ...
    public void performEffect(EntityLivingBase entity, int p_76394_2_) {
        ...
        List<EntityThrowable> projectiles = entity.worldObj.getEntitiesWithinAABB(EntityThrowable.class, AxisAlignedBB.fromBounds(entity.posX - 4.0D, entity.posY - 4.0D, entity.posZ - 4.0D, entity.posX + 3.0D, entity.posY + 3.0D, entity.posZ + 3.0D));
        for (EntityThrowable e : projectiles) {
