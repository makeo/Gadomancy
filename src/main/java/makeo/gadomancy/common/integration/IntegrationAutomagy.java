...
public class IntegrationAutomagy extends IntegrationMod {
    ...
    protected void doInit() {
        //TODO update once automagy includes infinity jar...
    ...
    //TODO god.. automagy please.
    /*public void tryFillGolemCrafttable(BlockPos cc, World world) {
        Class<?> workbenchTileClazz;
        try {
            workbenchTileClazz = Class.forName("tuhljin.automagy.common.tiles.TileGolemWorkbench");
