...
public class EventHandlerRedirect {
    ...
    private static final ItemStack ITEM_GOGGLES = new ItemStack(ItemsTC.goggles);
    ...
    public static void preNodeRender(TileEntity tile) {
        addGoggles(Minecraft.getMinecraft().getRenderViewEntity());
    }

    @SideOnly(Side.CLIENT)
    public static void postNodeRender(TileEntity tile) {
        removeGoggles(Minecraft.getMinecraft().getRenderViewEntity());
    }
