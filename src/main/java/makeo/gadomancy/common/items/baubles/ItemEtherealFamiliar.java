...
public class ItemEtherealFamiliar extends Item implements IBauble {
    ...
    public String getUnlocalizedName() {
        return Gadomancy.MODID + "_ItemEtherealFamiliar";
    }

    @Override
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        ItemStack stack = new ItemStack(item);
        setFamiliarAspect(stack, Aspect.AURA);
        list.add(stack);
    ...
    public static FamiliarAugment.FamiliarAugmentList getAugments(ItemStack stack) {
        ...
        Set<String> strKeySet = augmentTag.getKeySet();
    ...
    public boolean canEquip(ItemStack itemStack, EntityLivingBase entityLivingBase) {
        ...
        return ResearchManager.isResearchComplete(entityLivingBase.getName(), Gadomancy.MODID.toUpperCase() + ".ETHEREAL_FAMILIAR");
    }
