...
public class Vector3 {
    ...
    public static Vector3 fromBP(BlockPos bp) {
        return new Vector3(bp.getX(), bp.getY(), bp.getZ());
    }

    public BlockPos getAsFloatBlockPos() {
        return new BlockPos(Float.floatToIntBits((float) this.x), Float.floatToIntBits((float) this.y), Float.floatToIntBits((float) this.z));
    }

    public static Vector3 getFromFloatCC(BlockPos bp) {
        return new Vector3(Float.intBitsToFloat(bp.getX()), Float.intBitsToFloat(bp.getY()), Float.intBitsToFloat(bp.getZ()));
    }
