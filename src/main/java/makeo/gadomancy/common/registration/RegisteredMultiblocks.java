...
public class RegisteredMultiblocks {
    ...
    public static final MultiblockHelper.MultiblockPattern completeEldritchPortalCreator = new MultiblockHelper.MultiblockPattern(RegisteredBlocks.blockNodeManipulator, 5)
            ...
            .addBlock(1, 1, 1, RegisteredBlocks.blockStoneMachine, 11).addBlock(-1, 1, 1, RegisteredBlocks.blockStoneMachine, 11).addBlock(-1, 1, -1, RegisteredBlocks.blockStoneMachine, 11).addBlock(1, 1, -1, RegisteredBlocks.blockStoneMachine, 11);
*/
    public static final MultiblockHelper.MultiblockPattern auraPylonPattern = new MultiblockHelper.MultiblockPattern(RegisteredBlocks.blockAuraPylon.getDefaultState().withProperty(BlockAuraPylon.TYPE, BlockAuraPylon.PylonType.TOP))
            .addBlock(0, -1, 0, RegisteredBlocks.blockAuraPylon.getDefaultState().withProperty(BlockAuraPylon.TYPE, BlockAuraPylon.PylonType.TOWER))
            .addBlock(0, -2, 0, RegisteredBlocks.blockAuraPylon.getDefaultState().withProperty(BlockAuraPylon.TYPE, BlockAuraPylon.PylonType.TOWER))
            .addBlock(0, -3, 0, RegisteredBlocks.blockAuraPylon.getDefaultState().withProperty(BlockAuraPylon.TYPE, BlockAuraPylon.PylonType.TOWER));
}
