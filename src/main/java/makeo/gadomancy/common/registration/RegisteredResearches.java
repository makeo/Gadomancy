...
public class RegisteredResearches {
    ...
    public static void init() {
        ...
        ResearchCategories.registerCategory(Gadomancy.MODID, null, CATEGORY_ICON, CATEGORY_BACKGROUND);
        ...
        researchInfusionClaw = new SimpleResearchItem("INFUSIONCLAW", -6, -7, 5, new ItemStack(RegisteredBlocks.blockInfusionClaw),
                new AspectList().add(Aspect.ELDRITCH, 8).add(Aspect.MECHANISM, 8).add(Aspect.AURA, 8).add(Aspect.ORDER, 8).add(Aspect.DARKNESS, 4))
                .setParents(researchVFocusPrimal.key, researchItemVoidMetal.key, researchWandPedestal.key, researchVCoreUse.key)
        ...
        researchBlockProtector = new SimpleResearchItem("BLOCK_PROTECTOR", -6, -2, 2, new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 2),
                new AspectList().add(Aspect.ORDER, 10).add(Aspect.PROTECT, 8).add(Aspect.EARTH, 12).add(Aspect.LIGHT, 10).add(Aspect.AURA, 8))
        ...
        ItemEtherealFamiliar.setFamiliarAspect(displayFamiliar, Aspect.AURA);
        researchEtherealFamiliar = new SimpleResearchItem("ETHEREAL_FAMILIAR", 5, 1, 2, displayFamiliar,
                new AspectList().add(Aspect.AIR, 8).add(Aspect.FIRE, 6).add(Aspect.AURA, 4).add(Aspect.MOTION, 6))
                .setSpecial()
        ...
        researchFamiliarElementLightning = new SimpleResearchItem("FAMILIAR_SHOCK", 4, -1, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Lightning.png"),
                new AspectList().add(Aspect.ENERGY, 4).add(Aspect.AVERSION, 4).add(Aspect.AIR, 8))
        ...
        researchFamiliarElementFire = new SimpleResearchItem("FAMILIAR_FIRE", 6, -1, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Fire.png"),
                new AspectList().add(Aspect.FIRE, 8).add(Aspect.AVERSION, 4).add(Aspect.AURA, 4))
                .setParents(researchEtherealFamiliar.key)
        ...
        researchFamiliarElementPoison = new SimpleResearchItem("FAMILIAR_POISON", 3, 2, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Poison.png"),
                new AspectList().add(Aspect.TRAP, 8).add(Aspect.AVERSION, 4).add(Aspect.ENTROPY, 4).add(Aspect.WATER, 8))
                .setParents(researchEtherealFamiliar.key)
        ...
        researchFamiliarElementWeakness = new SimpleResearchItem("FAMILIAR_WEAKNESS", 2, 0, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Enervation.png"),
                new AspectList().add(Aspect.TRAP, 8).add(Aspect.AVERSION, 8).add(Aspect.FLUX, 6))
                .setParents(researchEtherealFamiliar.key)
        ...
        researchFamiliarAugmentDamage = new IfAnyParentResearchItem("FAMILIAR_DAMAGE", 8, 2, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Damage.png"),
                new AspectList().add(Aspect.AVERSION, 8).add(Aspect.ENERGY, 8).add(Aspect.AURA, 4))
        ...
        researchFamiliarAugmentRange = new IfAnyParentResearchItem("FAMILIAR_RANGE", 6, 4, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Range.png"),
                new AspectList().add(Aspect.AURA, 8).add(Aspect.ELDRITCH, 8).add(Aspect.ORDER, 4))
                .setAnyParents(researchFamiliarElementFire.key, researchFamiliarElementLightning.key,
                        researchFamiliarElementPoison.key, researchFamiliarElementWeakness.key)
                .setParents(researchEtherealFamiliar.key)
        ...
        researchFamiliarAugmentSpeed = new SimpleResearchItem("FAMILIAR_SPEED", 8, 5, 2, new ResourceLocation("gadomancy", "textures/misc/Fam_Speed.png"),
                new AspectList().add(Aspect.MOTION, 10).add(Aspect.AIR, 4).add(Aspect.AURA, 4))
        ...
        researchAuraCore = new AlternatingResearchItem("AURA_CORE",
                -1, 6, 2,
                new AspectList().add(Aspect.AURA, 22).add(Aspect.FLUX, 4).add(Aspect.AIR, 8).add(Aspect.WATER, 8)
        ...
        researchCleanAuraCore = new SimpleResearchItem("CLEAN_AURA_CORE",
                ...
                new AspectList().add(Aspect.ORDER, 8).add(Aspect.AURA, 6).add(Aspect.METAL, 12).add(Aspect.WATER, 10))
                .setSecondary()
        ...
        researchAuraPylon = new SimpleResearchItem("AURA_PYLON",
                ...
                new AspectList().add(Aspect.ORDER, 12).add(Aspect.AURA, 20).add(Aspect.METAL, 12).add(Aspect.MECHANISM, 8))
                .setHidden()
                .setParents(researchAuraCore.key, "TUBEFILTER")
                //TODO .setItemTriggers(new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.FIRE.ordinal()))
        ...
        researchAuraEffects = new SimpleResearchItem("AURA_EFFECTS",
                ...
                new AspectList().add(Aspect.AURA, 6).add(Aspect.MIND, 8).add(Aspect.MIND, 4).add(Aspect.ORDER, 4))
                .setSecondary()
        ...
        researchKnowledgeBook = new SimpleResearchItem("KNOWLEDGE_BOOK",
                ...
                new AspectList().add(Aspect.MIND, 12).add(Aspect.AURA, 8).add(Aspect.MOTION, 6).add(Aspect.ORDER, 10).add(Aspect.MECHANISM, 8).add(Aspect.CRAFT, 8))
                .setHidden()
                .setParents(researchAuraCore.key, "GOGGLES", "THAUMATORIUM")
                //TODO .setItemTriggers(new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.ORDER.ordinal()))
        ...
        String[] packagerParents = Config.wardedStone ? new String[] { researchAuraCore.key, "WARDEDARCANA" } : new String[] { researchAuraCore.key };
                ...
                2, 7, 2, new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 4),
                        new AspectList().add(Aspect.AIR, 12).add(Aspect.MECHANISM, 16).add(Aspect.VOID, 10).add(Aspect.AURA, 10))
                .setHidden()
                .setParents(packagerParents)
                //TODO .setItemTriggers(new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.AIR.ordinal()))
        ...
        ItemStack goggles = new ItemStack(ItemsTC.goggles);
        goggles.addEnchantment(Enchantment.protection, 1);
        researchRevealer = new SimpleResearchItem("REVEALER", 1, 3, 1, goggles, new AspectList().add(Aspect.SENSES, 4).add(Aspect.AURA, 4))
        ...
        researchArmorDisguise = new DisguiseResearchItem("ARMORDISGUISE", -2, 0, 1, new AspectList().add(Aspect.WATER, 8).add(Aspect.AURA, 4).add(Aspect.PROTECT, 4))
